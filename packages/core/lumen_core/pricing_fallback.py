...
def _pricing(
    ...
    *,
    ...
    cache_creation = int(
        (Decimal(input_micro) * cache_creation_ratio).to_integral_value()
    )
    return ModelPricing(
...
FALLBACK_PRICING: Mapping[str, ModelPricing] = immutable_mapping(
    {
        ...
        "gpt-5.4-mini": _pricing("0.00075", "0.0045"),
        "gpt-5.4-nano": _pricing("0.0002", "0.00125"),
        ...
        # Gemini family
        "gemini-2.5-pro": _pricing(
            "0.00125",
            "0.010",
            threshold=200_000,
            long_input_x=20_000,
            long_output_x=15_000,
        ),
