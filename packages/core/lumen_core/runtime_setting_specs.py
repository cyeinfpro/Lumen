...
SUPPORTED_SETTINGS: tuple[SettingSpec, ...] = (
    ...
    SettingSpec(
        key="ui.nav.studio_visible",
        description="是否向用户显示主导航里的「创作」入口。0=隐藏，1=显示。",
        sensitive=False,
        parser=int,
        env_fallback="UI_NAV_STUDIO_VISIBLE",
        min_value=0,
        max_value=1,
        allowed_values=("0", "1"),
    ),
    *AGENT_SETTINGS,
    SettingSpec(
        ...
        sensitive=False,
        parser=int,
        env_fallback="UI_NAV_VIDEO_VISIBLE",
        min_value=0,
        max_value=1,
        allowed_values=("0", "1"),
    ),
    SettingSpec(
        key="ui.nav.projects_visible",
        description="是否向用户显示主导航里的「项目」入口。0=隐藏，1=显示。",
        sensitive=False,
        parser=int,
        env_fallback="UI_NAV_PROJECTS_VISIBLE",
        min_value=0,
        max_value=1,
        allowed_values=("0", "1"),
    ),
    SettingSpec(
        key="ui.nav.assets_visible",
        description="是否向用户显示主导航里的「资产」入口。0=隐藏，1=显示。",
        sensitive=False,
        parser=int,
        env_fallback="UI_NAV_ASSETS_VISIBLE",
        min_value=0,
        max_value=1,
        allowed_values=("0", "1"),
    ),
    ...
    SettingSpec(
        key="byok.retention_hide_enabled",
        description="BYOK 用户数据超过保留窗口后是否从用户侧隐藏。0=关闭，1=开启。默认 1。",
        sensitive=False,
        parser=int,
        env_fallback="BYOK_RETENTION_HIDE_ENABLED",
        min_value=0,
        max_value=1,
        allowed_values=("0", "1"),
    ),
    SettingSpec(
        key="byok.retention_delete_enabled",
        description="BYOK 用户数据超过删除窗口后是否自动软删除。0=关闭，1=开启。默认 0。",
        sensitive=False,
        parser=int,
        env_fallback="BYOK_RETENTION_DELETE_ENABLED",
        min_value=0,
        max_value=1,
        allowed_values=("0", "1"),
    ),
    SettingSpec(
        key="byok.retention_hide_days",
        description="BYOK 用户侧隐藏窗口，单位天。默认 3 天；仅影响 BYOK 用户。",
        sensitive=False,
        parser=int,
        env_fallback="BYOK_RETENTION_HIDE_DAYS",
        min_value=1,
        max_value=3650,
    ),
    SettingSpec(
        key="byok.retention_delete_days",
        description="BYOK 自动软删除窗口，单位天。默认 7 天；仅影响 BYOK 用户。",
        sensitive=False,
        parser=int,
        env_fallback="BYOK_RETENTION_DELETE_DAYS",
        min_value=1,
        max_value=3650,
    ),
    SettingSpec(
...
__all__ = ["SUPPORTED_SETTINGS", "SettingSpec"]
