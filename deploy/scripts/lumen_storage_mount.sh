...
# vers=3.1.1 — SMB3.1.1 (encryption + integrity); fallback to 3.0 if peer rejects.
# soft + retrans=3 — survive transient drops without hanging containers.
# rsize/wsize=4M, bsize=1M — large-block IO friendly.
...
CIFS_OPTS_BASE="vers=3.1.1,soft,retrans=3,rsize=4194304,wsize=4194304,bsize=1048576,actimeo=1,cache=strict,echo_interval=60,noperm,mfsymlinks,mapposix,nounix,serverino,_netdev"
