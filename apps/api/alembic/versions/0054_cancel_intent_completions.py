"""Add the completions cancellation-intent index in its own retry boundary.

Revision ID: 0054_cancel_intent_completions
Revises: 0053_cancel_intent_generations
...
revision: str = "0054_cancel_intent_completions"
down_revision: str | None = "0053_cancel_intent_generations"
