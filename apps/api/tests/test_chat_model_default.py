...
def test_shared_default_chat_model_is_gpt_56_sol() -> None:
...
def test_api_config_default_chat_model_is_gpt_56_sol() -> None:
    settings = Settings(app_env="dev", upstream_default_model=DEFAULT_CHAT_MODEL)
    assert settings.upstream_default_model == "gpt-5.6-sol"
