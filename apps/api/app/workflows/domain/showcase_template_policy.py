...
TEMPLATE_LABELS = freeze_mapping(
    {
...
_RENDER_DIRECTIONS = freeze_mapping(
    {
        "white_ecommerce": (
...
_RENDER_DIRECTIONS_OUTDOOR = freeze_mapping(
    {
        "daily_snapshot": (
...
_POSE_DIRECTIONS = freeze_mapping(
    {
...
LIFESTYLE_TEMPLATES = _LIFESTYLE_TEMPLATES
POSE_DIRECTIONS = _POSE_DIRECTIONS
RENDER_DIRECTIONS = _RENDER_DIRECTIONS
RENDER_DIRECTIONS_OUTDOOR = _RENDER_DIRECTIONS_OUTDOOR
SQUARE_OR_LANDSCAPE_RATIOS = _SQUARE_OR_LANDSCAPE_RATIOS
scene_environment_outdoor_phrase = _scene_environment_outdoor_phrase
showcase_composition_direction = _showcase_composition_direction
showcase_framing_direction = _showcase_framing_direction
showcase_pose_direction = _showcase_pose_direction
showcase_render_direction = _showcase_render_direction
template_requirement = _template_requirement
...
__all__ = [
    ...
    "POSE_DIRECTIONS",
    "RENDER_DIRECTIONS",
    "RENDER_DIRECTIONS_OUTDOOR",
    "SQUARE_OR_LANDSCAPE_RATIOS",
    "TEMPLATE_LABELS",
    ...
    "showcase_composition_direction",
    "showcase_framing_direction",
    "showcase_pose_direction",
    "showcase_render_direction",
    "scene_environment_outdoor_phrase",
