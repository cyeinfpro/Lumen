...
CHILD_POOL: ShotPool = freeze_mapping(
    {
        "white_ecommerce": {
            "front_full_body": [
                {
            ...
            "natural_pose": [
                ...
                {
                    "label": "白底前微侧身低头看口袋，双脚站稳",
                    "framing": "product_first",
                },
                {
                    "label": "白底前自然站立，小手轻碰裙摆边缘",
                    "framing": "product_first",
                },
            ],
            "detail_half_body": [
        ...
        "premium_studio": {
            ...
            "natural_pose": [
                ...
                {
                    "label": "棚拍窗光边自然站立，视线略看向一侧",
                    "framing": "tone_first",
                },
                {
                    "label": "棚拍浅墙前小步站定，前后脚都接地",
                    "framing": "product_first",
                },
            ],
            "detail_half_body": [
        ...
        "urban_commute": {
            ...
            "natural_pose": [
                ...
                {
                    "label": "小书店门口自然站立，视线看向橱窗外侧",
                    "framing": "tone_first",
                },
                {
                    "label": "花坛旁低头看口袋，小手轻碰口袋边缘",
                    "framing": "product_first",
                },
            ],
            "detail_half_body": [
                ...
                {
                    "label": "上身近景，街角石阶旁小手轻碰前襟",
                    "framing": "product_first",
                },
                {
                    "label": "上身近景，小书店门口小手整理袖口",
                    "framing": "product_first",
                },
            ],
            "side_or_back": [
                ...
                {
                    "label": "公园门口完整背面站立，头自然朝前",
                    "framing": "product_first",
                },
                {
                    "label": "街边台阶旁45度侧身站定，背景轻微虚化",
                    "framing": "tone_first",
                },
            ],
        },
        "lifestyle": {
            ...
            "side_or_back": [
                {
                    "label": "画廊白墙前完整侧身站立，展示衣长",
                    "framing": "product_first",
                },
                {
                    "label": "酒店大堂完整背面站姿，手臂自然垂落",
                    "framing": "product_first",
                },
                {
                    "label": "木质走廊背面全身站定，空间留白干净",
                    "framing": "tone_first",
                },
            ],
        },
        "daily_snapshot": {
            ...
            "side_or_back": [
                {
                    "label": "沙发旁完整侧身站立，展示侧面版型",
                    "framing": "product_first",
                },
                {
                    "label": "阳台窗前完整背面站立，头自然朝前",
                    "framing": "product_first",
                },
                {
                    "label": "楼梯口45度侧身站定，扶手只作为背景",
                    "framing": "tone_first",
                },
            ],
        },
...
TODDLER_POOL: ShotPool = freeze_mapping(
    {
        "white_ecommerce": {
            "front_full_body": [
                {
        ...
        "lifestyle": {
            "front_full_body": [
                {
                    "label": "画廊白墙前正面全身站定，双脚平放",
                    "framing": "product_first",
                },
                {
                    "label": "酒店大堂前远一点的全身站姿，人物完整",
                    "framing": "tone_first",
                },
            ],
            "natural_pose": [
                {
                    "label": "画廊前侧身十五度站立，小手轻扶前襟",
                    "framing": "product_first",
                },
                {
                    "label": "精品店落地灯旁自然站定，视线略偏侧",
                    "framing": "tone_first",
                },
            ],
            "detail_half_body": [
                {
                    "label": "画廊前半身小手扶领口，衣服细节清楚",
                    "framing": "product_first",
                },
        ...
        "social_seed": {
            "front_full_body": [
                {
                    "label": "试衣间软凳旁正面全身站定，双脚平放",
                    "framing": "product_first",
                },
                {
                    "label": "卧室衣柜前正面全身轻扶衣角展示穿搭",
                    "framing": "product_first",
                },
            ],
            "natural_pose": [
