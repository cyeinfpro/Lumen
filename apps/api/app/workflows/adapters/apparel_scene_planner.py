...
async def resolve_scene_provider_order(
    ...
    async with provider_runtime.lock:
        return weighted_priority_order(providers, provider_runtime.counters)
...
async def _call_gpt55_json(
    ...
    *,
    ...
    providers = await _resolve_gpt55_providers(db, provider_selection)
...
async def _resolve_gpt55_providers(
    ...
    if selection is not None and selection.order is not None:
        ...
        providers = await resolve_scene_provider_order(db, selection.runtime)
    else:
