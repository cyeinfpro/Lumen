...
from ..domain.showcase_shot_pool import (
    ShotVariant,
    age_soft_constraint as _age_soft_constraint,
)
from ..domain.showcase_template_policy import (
...
from ..domain.showcase_scene_policy import showcase_scene_label as _showcase_scene_label  # noqa: F401
from ..domain.showcase_scene_policy import (
...
def _showcase_prompt(
    *,
    ...
    selected_candidate: _ModelCandidateLike,
