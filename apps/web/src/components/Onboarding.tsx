  ...
  return (
    ...
    >
      ...
      <motion.h1
        ...
        className="type-display-lg mx-auto max-w-[22rem] break-words text-balance sm:max-w-2xl"
      >
        从一句话开始，
          ...
          >
            <div className="flex items-start gap-3 lg:block">
              ...
              <span className="min-w-0 flex-1 lg:mt-3 lg:block">
                <span className="block type-body-sm font-medium leading-tight text-[var(--fg-0)]">
                  {loading ? "处理中…" : preset.title}
                </span>
                <span className="mt-1 block type-caption leading-snug text-[var(--fg-2)]">
                  {preset.hint}
                </span>
              </span>
            </div>
