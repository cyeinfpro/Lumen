            ...
            secondaryAction={
              <div className="flex w-full min-w-0 flex-col gap-2 sm:w-auto sm:flex-row">
                ...
                <Link
                  ...
                  className="inline-flex min-h-11 w-full items-center justify-center gap-1.5 rounded-[var(--radius-control)] px-3 type-body-sm font-medium text-[var(--fg-1)] transition-colors hover:bg-[var(--bg-2)] hover:text-[var(--fg-0)] focus-visible:outline-none focus-visible:shadow-[var(--ring)] sm:w-auto"
                >
