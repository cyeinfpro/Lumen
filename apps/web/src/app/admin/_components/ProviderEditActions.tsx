    ...
    <AnimatePresence>
      {open ? (
        <motion.div
          ...
          className="fixed bottom-0 left-0 right-0 z-[var(--z-tray)] max-w-full px-4 pb-[env(safe-area-inset-bottom)] sm:bottom-4 sm:left-1/2 sm:right-auto sm:w-auto sm:max-w-[calc(100vw-2rem)] sm:-translate-x-1/2 sm:px-0 sm:pb-4"
        >
